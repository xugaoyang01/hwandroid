 ...
 */
public class HWListActivity extends HWActivity {

    private static final String LOG_TAG = HWListActivity.class.getSimpleName();
    ...
    public HWListActivity(ActionBar.Type actionBarType) {
        super(actionBarType);
    }
     ...
     * 
     * @return The ListView managed by the current {@link HWListActivity}
     */
    ...
    public int createLayout() {
        ...
        switch (getActionBarType()) {
            case Dashboard:
                return R.layout.hw_list_content_dashboard;
            case Empty:
                return R.layout.hw_list_content_empty;
            case Normal:
            default:
