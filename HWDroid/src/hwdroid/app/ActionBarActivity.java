...
public interface ActionBarActivity {
     ...
     */
    static final String HW_ACTION_BAR_TITLE = "hwdroid.app.ActionBarActivity.HW_ACTION_BAR_TITLE";

    /**
     * An integer that can be used to force the ActionBar to a particular
     * visibility. This is especially useful when using HWActivity inside a
     * HWTabActivity.
     * 
     * @see View#VISIBLE
     * @see View#INVISIBLE
     * @see View#GONE
     */
    static final String HW_ACTION_BAR_VISIBILITY = "hwdroid.app.ActionBarActivity.HW_ACTION_BAR_VISIBILITY";
     ...
     * @see ActionBarActivity#addActionBarItem(hwdroid.widget.ActionBarItem.Type)
     * @return The {@link ActionBar} currently displayed on screen
     */
    ActionBar getActionBarImpl();

    /**
     * A simple utility method that casts the Application returned by
     * Activity.getApplication() into a {@link HWApplication}
     * 
     * @return The current {@link HWApplication}
     */
    HWApplication getHWApplication();
