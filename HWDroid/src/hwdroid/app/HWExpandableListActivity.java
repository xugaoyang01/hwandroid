...
/**
 * A {@link HWActivity} equivalent to ExpandableListActivity that manages an
 * ExpandableListView.
 */
public class HWExpandableListActivity extends HWActivity implements OnCreateContextMenuListener, ExpandableListView.OnChildClickListener,
    ...
    public HWExpandableListActivity() {
        super();
    }

    public HWExpandableListActivity(ActionBar.Type actionBarType) {
        super(actionBarType);
    }
    ...
    public int createLayout() {
        switch (getActionBarType()) {
            case Dashboard:
                return R.layout.hw_expandable_list_content_dashboard;
            case Empty:
                return R.layout.hw_expandable_list_content_empty;
            case Normal:
            default:
                return R.layout.hw_expandable_list_content_normal;
        }
    }
