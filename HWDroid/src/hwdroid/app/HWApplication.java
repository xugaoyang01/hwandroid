...
public class HWApplication extends Application {
     ...
     * 
     * @author Cyril Mottier
     * @see HWApplication#registerOnLowMemoryListener(OnLowMemoryListener)
     * @see HWApplication#unregisterOnLowMemoryListener(OnLowMemoryListener)
     */
    ...
    private static final ThreadFactory sThreadFactory = new ThreadFactory() {
        ...
        public Thread newThread(Runnable r) {
            return new Thread(r, "HWDroid thread #" + mCount.getAndIncrement());
        }
    };
