 ...
 */
package hwdroid.image;

import hwdroid.app.HWApplication.OnLowMemoryListener;
import hwdroid.util.HWUtils;
...
public class ImageCache implements OnLowMemoryListener {
    ...
    public ImageCache(Context context) {
        ...
        HWUtils.getHWApplication(context).registerOnLowMemoryListener(this);
    }

    public static ImageCache from(Context context) {
        return HWUtils.getImageCache(context);
    }
