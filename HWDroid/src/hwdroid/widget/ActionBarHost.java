...
public class ActionBarHost extends LinearLayout {
    ...
    protected void onFinishInflate() {
        ...
        mActionBar = (ActionBar) findViewById(R.id.hw_action_bar);
        if (mActionBar == null || !(mActionBar instanceof ActionBar)) {
            throw new IllegalArgumentException("No ActionBar with the id R.id.hw_action_bar found in the layout.");
        }
