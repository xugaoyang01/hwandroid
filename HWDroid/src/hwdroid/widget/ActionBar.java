...
public class ActionBar extends LinearLayout {
     ...
     *             {@link ActionBar#addItem(hwdroid.widget.ActionBarItem.Type, int)}
     */
    ...
    public ActionBar(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.hwActionBarStyle);
    }
    ...
    public ActionBar(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (mHomeDrawable == null) {
            mHomeDrawable = new ActionBarDrawable(context, R.drawable.hw_action_bar_home);
        }
        ...
        switch (type) {
            case 2:
                mType = Type.Empty;
                layoutID = R.layout.hw_action_bar_empty;
                break;
            case 1:
                mType = Type.Dashboard;
                layoutID = R.layout.hw_action_bar_dashboard;
                break;
            case 0:
            default:
                mType = Type.Normal;
                layoutID = R.layout.hw_action_bar_normal;
                break;
        }
    ...
    protected void onFinishInflate() {
        ...
        if (!mMerging) {
            ...
            switch (mType) {
                case Dashboard:
                    mHomeButton = (ImageButton) findViewById(R.id.hw_action_bar_home_item);
                ...
                default:
                    ...
                    mHomeButton.setContentDescription(getContext().getString(R.string.hw_go_home));
                    mTitleView = (TextView) findViewById(R.id.hw_action_bar_title);
                    setTitle(mTitle);
                    break;
    ...
    public ActionBarItem addItem(ActionBarItem item, int itemId) {
        ...
        if (item != null) {
            ...
            itemView.findViewById(R.id.hw_action_bar_item).setOnClickListener(mClickHandler);

            final int size = (int) getResources().getDimension(R.dimen.hw_action_bar_height);
        ...
        public void onClick(View v) {
            if (mOnActionBarListener != null) {
                ...
                for (int i = 0; i < itemCount; i++) {
                    ...
                    final View itemButton = item.getItemView().findViewById(R.id.hw_action_bar_item);
                    if (v == itemButton) {
                        item.onItemClicked();
