...
public abstract class QuickActionWidget extends PopupWindow {
    ...
    private void initializeDefault() {
        ...
        mArrowOffsetY = mContext.getResources().getDimensionPixelSize(R.dimen.hw_arrow_offset);
    }
    ...
    private void prepareAnimationStyle() {
        ...
        if (arrowPointX <= screenWidth / 4) {
            setAnimationStyle(onTop ? R.style.HWDroid_Animation_PopUp_Left
                    : R.style.HWDroid_Animation_PopDown_Left);
        } else if (arrowPointX >= 3 * screenWidth / 4) {
            setAnimationStyle(onTop ? R.style.HWDroid_Animation_PopUp_Right
                    : R.style.HWDroid_Animation_PopDown_Right);
        } else {
            setAnimationStyle(onTop ? R.style.HWDroid_Animation_PopUp_Center
                    : R.style.HWDroid_Animation_PopDown_Center);
        }
    }
