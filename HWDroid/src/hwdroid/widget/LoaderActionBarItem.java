...
public class LoaderActionBarItem extends NormalActionBarItem {
    ...
    protected View createItemView() {
        return LayoutInflater.from(mContext).inflate(R.layout.hw_action_bar_item_loader, mActionBar, false);
    }

    @Override
    protected void prepareItemView() {
        super.prepareItemView();
        mButton = mItemView.findViewById(R.id.hw_action_bar_item);
        mProgressBar = mItemView.findViewById(R.id.hw_action_bar_item_progress_bar);
    }
