...
public class NormalActionBarItem extends ActionBarItem {
    ...
    protected View createItemView() {
        return LayoutInflater.from(mContext).inflate(R.layout.hw_action_bar_item_base, mActionBar, false);
    }

    @Override
    protected void prepareItemView() {
        super.prepareItemView();
        final ImageButton imageButton = (ImageButton) mItemView.findViewById(R.id.hw_action_bar_item);
    ...
    protected void onContentDescriptionChanged() {
        ...
        mItemView.findViewById(R.id.hw_action_bar_item).setContentDescription(mContentDescription);
    }

    @Override
    protected void onDrawableChanged() {
        super.onDrawableChanged();
        ImageButton imageButton = (ImageButton) mItemView.findViewById(R.id.hw_action_bar_item);
        imageButton.setImageDrawable(mDrawable);
    }
