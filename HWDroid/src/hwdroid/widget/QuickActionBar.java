...
public class QuickActionBar extends QuickActionWidget {
    ...
    public QuickActionBar(Context context) {
        ...
        mRackAnimation = AnimationUtils.loadAnimation(context, R.anim.hw_rack);
        ...
        setContentView(R.layout.hw_quick_action_bar);
    ...
    protected void populateQuickActions(List<QuickAction> quickActions) {
        ...
        for (QuickAction action : quickActions) {
            TextView view = (TextView) inflater.inflate(R.layout.hw_quick_action_bar_item, mQuickActionItems, false);
