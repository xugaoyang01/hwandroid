 ...
 */
package hwdroid.graphics.drawable;
 ...
 * </p>
 * <p>
 * HWDroid offers a smart way to change the default alternative and normal
...
public class ActionBarDrawable extends BitmapDrawable {
    ...
    public ActionBarDrawable(Context context, Drawable d) {
        ...
        this(context, d, getColorFromTheme(context, R.attr.hwActionBarItemColorNormal, Color.WHITE), getColorFromTheme(context,
                R.attr.hwActionBarItemColorAlt, Color.BLACK));
    }
