...
import hwdroid.app.ActionBarActivity;
import hwdroid.app.HWTabActivity;

public class InfoTabActivity extends HWTabActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        aboutIntent.putExtra(ActionBarActivity.HW_ACTION_BAR_VISIBILITY, View.GONE);
        ...
        licenseIntent.putExtra(ActionBarActivity.HW_ACTION_BAR_VISIBILITY, View.GONE);
